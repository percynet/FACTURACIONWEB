...
function numerosALetras($xcifra, $xmoneda = "SOLES")
{ 
 $xarray = array(0 => "Cero",
 	1 => "UN", "DOS", "TRES", "CUATRO", "CINCO", "SEIS", "SIETE", "OCHO", "NUEVE", 
 	"DIEZ", "ONCE", "DOCE", "TRECE", "CATORCE", "QUINCE", "DIECISEIS", "DIECISIETE", "DIECIOCHO", "DIECINUEVE", 
 	"VEINTI", 30 => "TREINTA", 40 => "CUARENTA", 50 => "CINCUENTA", 60 => "SESENTA", 70 => "SETENTA", 80 => "OCHENTA", 90 => "NOVENTA", 
 	100 => "CIENTO", 200 => "DOSCIENTOS", 300 => "TRESCIENTOS", 400 => "CUATROCIENTOS", 500 => "QUINIENTOS", 600 => "SEISCIENTOS", 700 => 			
	...
	if (trim($xaux) != "")
 	{
 		...
 		case 2:
			if ($xcifra < 1 )
 			{
 				$xcadena = "CERO CON $xdecimales/100 ".$xmoneda;		//"CERO DOLARES $xdecimales/100 ";
 			}
 			if ($xcifra >= 1 && $xcifra < 2)
			{
				$xcadena = "UN CON $xdecimales/100 ".$xmoneda;			//"UN DOLAR $xdecimales/100 ";
			}
 			if ($xcifra >= 2)
 			{
 				$xcadena.= " CON $xdecimales/100 ".$xmoneda; // $xcadena.= " DOLARES $xdecimales/100 ";
 			}
 			break;
 		} // endswitch ($xz)
 	} // ENDIF (trim($xaux) != "")
