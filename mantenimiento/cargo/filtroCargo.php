...
<script type="text/javascript">
    ...
    $(document).ready(function(){	  
        ...
        $("#resultadoFiltroDiv").load("mantenimiento/cargo/listaCargo.php?p="+Math.random(), { filtro: filtro, valor: valor });
    });
	...
	function Nuevo_Documento(){
		...
		$("#content").load("mantenimiento/cargo/formCargo.php?p="+Math.random(), { accion: accion, idDocumento: idDocumento });
    ...
    function Nueva_Cargo(){

        Ir_A_Pagina("cargo/formCargo");
