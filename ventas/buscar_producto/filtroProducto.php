...
-->            
                ...
                <div class="dataTable_wrapper">
                    ...
                    <div class="row">
                 	...
                 	<div style="margin-top:5px; margin-right:15px;" align="right">
                        <p>
                            <button class="btn" id="btnAceptar" onclick="Seleccionar_Producto();">
                            		<i class="icon-ok"></i> Aceptar</button>&nbsp;
                            <button class="btn" id="btnCancelar" onclick="Cerrar_Popup_Buscar_Producto();">
            ...
            <input type="hidden" id="tipoProducto" value="<?= $tipoProducto; ?>"  />
<!--
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){	  
        ...
        $("#resultadoFiltroDiv").load("ventas/buscar_producto/listaProducto.php?p="+Math.random(), 
			{ tipoProducto: tipoProducto, filtro: filtro, valor: valor });
    });	
